...
botones.forEach((boton) => {
  boton.addEventListener("click", () => {
    ...
    alert(
      "Sabores del Norte te agradece por tu compra 🧡\n¡Esperamos que lo disfrutes!"
    );
  });
});
...
const comidas = {
  ...
  provoleta: {
    nombre: "Provoleta",
    precio: 1700,
    imagen: "img/provoletarellena.jpg",
  },
  matambre: {
    nombre: "Matambre a la pizza",
    precio: 3900,
    imagen: "img/matambrealapizza.jpg",
  },
};
...
document.getElementById("finalizar-compra").addEventListener("click", () => {
  ...
  resumenCarrito.innerHTML =
    "<strong>Resumen de tu pedido:</strong><ul style='margin-top: 0.5rem;'>";
...
document
  .getElementById("pago-transferencia-modal")
...
document
  .getElementById("btn-pagar-transferencia")
  .addEventListener("click", () => {
...
document.getElementById("pagar-tarjeta").addEventListener("click", function () {
  ...
  document
    .getElementById("formulario-tarjeta")
    .scrollIntoView({ behavior: "smooth" });
});

document
  .getElementById("form-tarjeta")
...
document
  .getElementById("pagar-transferencia")
  .addEventListener("click", function () {
    alert(
      "📦 El método de transferencia lo encontrás al finalizar la compra con el carrito."
    );
  });
